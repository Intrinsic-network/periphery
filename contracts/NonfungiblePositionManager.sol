...
/// @title NFT positions
/// @notice Wraps Intrinsic positions in the ERC721 non-fungible token interface
    ...
    SelfPermit
{
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IIntrinsicPool pool = IIntrinsicPool(PoolAddress.computeAddress(factory, poolKey));
